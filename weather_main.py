...
if __name__ == "__main__":
    ...
    data_display.log_to_file('data//{0}-{1}'.format(city_name,str(now.date())), min_current, max_current, hist_weather.min_avg, hist_weather.max_avg, hist_weather.min_extrm, hist_weather.max_extrm, now)
